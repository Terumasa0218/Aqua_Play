...
2. the work report has been provided,
3. the user has checked the result,
4. the user says the phase is OK or gives the next instruction.
...
11. Stop and wait for user confirmation before the next phase.
...
Pull requests can be automated when requested or when the user has agreed that PR creation should be automatic. Merging into `main` requires explicit user approval unless the user has clearly delegated that operation.
