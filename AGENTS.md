...
2. Read `AI_RULES.md`.
3. Read `PLAN.md`.
4. Read `AQUAPLAY_GARDEN_SPEC.md` for game design and MVP scope.
5. Confirm the working directory is the repository root.
6. Run `git status --short`.
7. Identify the files expected to change before editing.
...
2. `AGENTS.md` and `PLAN.md` for current project direction.
